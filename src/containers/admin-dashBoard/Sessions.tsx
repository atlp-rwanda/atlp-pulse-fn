...
const AdminSission = () => {
    ...
    return (
        ...
        <>
            ...
            <div className={`h-screen w-screen bg-black bg-opacity-30 backdrop-blur-sm absolute flex items-center justify-center px-4 ${addSessionModel === true ? 'block' : 'hidden'}`}>
            ...
            <div className={`min-h-full w-screen z-30 bg-black bg-opacity-30 backdrop-blur-sm absolute flex items-center justify-center px-4 ${deleteSessionModel === true ? 'block' : 'hidden'}`}>
                <div className="bg-white dark:bg-dark-bg w-full sm:w-3/4 md:w-1/2  xl:w-4/12 rounded-lg p-4 pb-8">
                    <div className="card-title w-full flex  flex-wrap justify-center items-center  ">
            ...
            <div className={`min-h-full w-screen z-30 bg-black bg-opacity-30 backdrop-blur-sm absolute flex items-center justify-center px-4 ${updateTraineeModel === true ? 'block' : 'hidden'}`}>
                <div className="bg-white dark:bg-dark-bg w-full sm:w-3/4 md:w-1/2  xl:w-4/12 rounded-lg p-4 pb-8">
                    <div className="card-title w-full flex  flex-wrap justify-center items-center  ">
                        <h3 className='font-bold text-sm text-gray-700 dark:text-white text-center w-11/12'>
                            {t('UpdateSession')}
            ...
            <div className="bg-light-bg dark:bg-dark-frame-bg min-h-screen lg:px-8">
                <div className="flex items-left px-8 lg:px-60 pt-24 pb-8">
                    <div className="space-x-8">
                        <button className="bg-primary px-4 py-2 rounded-md text-white font-semibold tracking-wide cursor-pointer" onClick={removeModel}>{t('Session')} +</button>
                    </div>
                </div>
                <div className="px-3 md:px-8">
                    <div className="bg-white dark:bg-dark-bg shadow-lg px-5 py-8 rounded-md w-full lg:w-[80%] lg:ml-52">
                        <div className=" flex items-center justify-between pb-6">
                            <div>
                                <h2 className="text-gray-800 dark:text-white font-semibold">{t('Availablesessions')}</h2>
                            </div>
                        </div>
                        <div>
                                ...
                                <div className="inline-block w-full lg:min-w-full shadow rounded-lg overflow-hidden">
                                    <table className="min-w-full leading-normal">
                                        <thead >
                                            <tr>
                                                <th
                                                    className="p-6 border-b-2 border-gray-200 bg-gray-100 dark:bg-dark-tertiary text-left text-xs font-semibold text-gray-600 dark:text-white uppercase tracking-wider">
                                                   {t('Session')}
                                                </th>

                                                <th
                                                    className="px-5 border-b-2 border-gray-200 bg-gray-100 dark:bg-dark-tertiary text-left text-xs font-semibold text-gray-600 dark:text-white uppercase tracking-wider">
                                                    {t("Description")}
                                                </th>
                                                <th
                                            ...
                                            <tr>
                                                ...
                                                <td className="px-5 py-5 text-gray-500 border-b border-gray-200 bg-white dark:bg-dark-bg text-lg">
                                                    <div className='flex relative flex-row '>
                                                        ...
                                                        {showActions ? <div className='absolute top-0 bg-white z-20 dark:bg-dark-bg text-gray-500 dark:text-white ml-4 flex justify-center items-center border rounded dark:border-white'>
                                                            <div className=' px-3 cursor-pointer'>
                                                                <ul>
                                                                    <li className='hover:text-primary' onClick={() => updateSessionModel()}>
                                                                    {t('Edit')}
                                                                    </li>
