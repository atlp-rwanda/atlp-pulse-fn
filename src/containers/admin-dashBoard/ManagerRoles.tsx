              ...
              <div>
                ...
                <div className="flex flex-cols items-center w-full justify-around">
                  <div className="flex cursor-pointer ">
                    <div className="px-2 py-3 underline text-primary hover:underline hover:text-primary">
                      {t('All')}
                    </div>
                    <div className="px-2 py-3 hover:underline hover:text-primary dark:text-white">
                      {t('Admins')}
                    </div>
                    <div className="px-2 py-3 hover:underline hover:text-primary dark:text-white">
                      {t('Coordinator')}
