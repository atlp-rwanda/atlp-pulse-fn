...
function AdminDocs() {
  ...
  const handleDeleteSubDocumentation = (id: string, title: string, description: string) => {
  ...
  const handleAddDocumentation = (title: string, description: string,role: string) => {
    setButtonLoading(true);
    if(isSubDocument){
      ...
      if (documentation.id === pageNumber) {
        if(selectedDocId===pageNumber){
          ...
          setSelectedDocId('')
              ...
              document.getElementById(`${documentation.id}`)?.classList.remove('hidden');
        }
            ...
            <form className="px-8 py-3 ">
              <div className="flex flex-wrap items-center justify-center w-full card-title ">
                <h3 className="w-11/12 text-sm font-bold text-center dark:text-white ">
                  ...
                  ):t( 'Enter the title and description of the document you want to add')}
                </h3>
              </div>
              ...
              <div className="my-3 text-white input h-9 ">
                <div className="flex items-center w-full h-full text-white rounded-md grouped-input">
                <select name="" id=""  className={isSubDocument?'hidden':`w-full px-5 py-2 font-sans text-xs text-black border rounded outline-none dark:bg-dark-tertiary border-primary`} onChange={
  (e)=> {
  ...
  other users
              ...
              <div className="flex justify-between w-full">
                ...
                <Button
                  ...
                  style="w-[30%] md:w-1/4 text-sm font-sans"
                  onClick={() => {
                    isUpdate?handleUpdateDocumentation(selectedDocId):
  ...
  {selectedContent && (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="overflow-auto lg:mx-60 xl:mx-96 w-[800px] md:w-[600px] transform rounded-2xl bg-white dark:bg-dark-bg p-6 text-left align-middle shadow-xl transition-all">
        ...
        <h2 className="mb-4 text-2xl font-bold">{selectedContent.title}</h2>
      <p>
