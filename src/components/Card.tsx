...
const Card = ({ text, number }: { text: string; number: any }) => {
  return (
    <div className="border bg-white py-4 dark:bg-dark-bg md:w-[75%] h-24 md:h-32 mx-2 md:ml-16 lg:ml-10 mt-12 md:mt-20 lg:mt-8 text-center flex flex-col justify-center items-center rounded-lg">
