...
function ProfileDropdown({
  ...
  return (
    <div className="w-screen h-screen fixed top-0 left-0 z-50 px-4">
      ...
      />
      <div className="absolute top-[60px] right-0 left-0 ml-auto px-2 md:mx-0 md:left-auto md:right-[6px] z-2  w-full max-w-[220px] h-[calc(100%-70px)]">
            ...
            <div className="w-full border-border-dark dark:border-white border-b-[0.5px]">
              <div className="flex flex-row justify-between align-center gap-x-[20px] ">
                <div className="flex flex-col w-full gap-[5px] cursor-pointer">
                  <p className="font-semibold text-gray-600 dark:text-white px-4 py-2 hover:bg-gray-600 hover:text-gray-200 dark:hover:bg-gray-300 dark:hover:text-gray-900">
                    <Link to="/dashboard/profile">{t('Profile')}</Link>
                  </p>
                  <p className="font-semibold text-gray-600 dark:text-white px-4 py-2 hover:bg-gray-600 hover:text-gray-200 dark:hover:bg-gray-300 dark:hover:text-gray-900">
                    <Link to="#link">{t('Preference')}</Link>
                  </p>
                  <p className="font-semibold text-gray-600 dark:text-white px-4 py-2 hover:bg-gray-600 hover:text-gray-200 dark:hover:bg-gray-300 dark:hover:text-gray-900">
                    <Link to="settings">{t('Privacy')}</Link>
                  </p>
                </div>
              </div>
            </div>
