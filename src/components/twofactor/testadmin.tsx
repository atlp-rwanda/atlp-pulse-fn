...
//  // Import the VerifyOneTimeCodeComponent here
//  import  Verify2FAForm  from '../../components/twofactor/verifyonlogin';
 
//  function AdminLogin() {
//    const orgToken: any = localStorage.getItem('orgToken');
//    const orgName: any = localStorage.getItem('orgName');
//    const [loading, setLoading] = useState(false);
//    const [needs2FA, setNeeds2FA] = useState(false); // State to handle 2FA
...
//              // Check if 2FA is required in the error response
//              if (err.message.toLowerCase() === '2fa required') {
//                setNeeds2FA(true);
//              }
//            } else {
//              setError('password', {
...
//                {/* Conditional rendering of the 2FA component */}
//                {needs2FA ? (
//                <Verify2FAForm 
