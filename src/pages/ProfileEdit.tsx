...
function EditProfile() {
  ...
  return (
    <div className="h-full overflow-y-scroll bg-light-bg dark:bg-dark-frame-bg font-serif">
      ...
      {tab === 0 && (
        <div className="font-serif border bg-indigo-100 dark:border-dark-bg  dark:bg-dark-bg dark:text-white w-full h-fit my-6 rounded-lg">
          <div className="px-4">
            <Button
              variant="default"
              size="md"
            ...
            <form
              className="grid grid-cols-1 gap-4 mt-12 md:grid-cols-2 font-serif"
            ...
            >
              ...
              <div className="flex flex-col items-start justify-start md:col-span-2 font-serif">
