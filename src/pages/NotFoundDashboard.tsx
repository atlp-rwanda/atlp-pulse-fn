...
function NotFound() {
  ...
  return (
    <div className=" dark:bg-dark-frame-bg flex flex-row py-8 px-5  md:flex-row items-center justify-end md:justify-evenly grow h-full w-full ">
      <div className="bg-light-bg dark:bg-dark-bg px-4 py-5 rounded-3xl max-w-md flex flex-col h-full">
        ...
        <h2 className="text-[3rem] font-bold font-lexend text-primary ">
          {t('NOT FOUND')}
        </h2>
