...
function Message() {
  ...
  return (
    <div className="md:flex md:flex-col md:items-center md:justify-center w-full  grow  text-center py-2 sm:flex sm:flex-row sm:items-center sm:justify-center">
