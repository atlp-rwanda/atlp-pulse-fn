...
const AdminLogin = () => {
  ...
  return (
    <>
      <div className="md:flex md:flex-col md:items-center md:justify-center w-full  min-h-screen  text-center py-2  dark:bg-dark-bg bg-gray-100  sm:flex sm:flex-row sm:items-center sm:justify-center">
        <div className="bg-white md:rounded-2xl md:shadow-2xl md:flex md:w-2/3 mt-16 md:max-w-4xl sm:max-w-xl sm:rounded-none sm:shadow-none dark:shadow-2xl ">
          <div className="md:w-3/5 md:p-5 sm:w-full sm:p-2 dark:bg-dark-frame-bg dark:rounded-tl-2xl dark:rounded-none ">
            <div className="py-10 sm:py-8 ">
              ...
              <div className="border-2 w-10 bg-primary border-primary inline-block mb-2"></div>
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="flex w-64 justify-between rounded mb-5 mt-5">
                  ...
                  <a href="#" className="text-xs dark:text-dark-text-fill ">
                    Forgot Password?
                  </a>
                </div>
                <a
