  ...
  return (
    <div className="flex flex-col  grow dark:bg-dark-frame-bg font-serif" style={{ minHeight: '80vh' }}>
      <div className="flex flex-col justify-center items-center flex-grow" style={{ flexGrow: 1 }}>
        {norating ? 
          <div className="containered flex items-center justify-center w-full h-full ">
            <div className="centered d-block text-center justify-center">
              <img src='https://res.cloudinary.com/dmems8p0a/image/upload/v1727875739/brizjlb7mkhekbxgcsdz.png'
                style={{height:'180px', width:'180',margin:'auto'}}
                alt='not found'
              />
              <span className='text-muted text-lg font-bold text-red-700'>You have no ratings yet...</span><br/>
              <span className='text-muted text-sm'>Once you receive ratings they will be displayed here</span>
            </div>
          </div>
        :
