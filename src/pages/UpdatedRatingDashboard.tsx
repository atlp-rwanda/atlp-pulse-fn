...
const UpdatedRatingDashboard = () => {
  ...
  return (
    ...
    <>
     {/* =========================== Start::  approveModel =============================== */}
     <div className={`min-h-full w-screen z-30 bg-black bg-opacity-30 backdrop-blur-sm absolute flex items-center justify-center px-4 ${approveModel === true ? 'block' : 'hidden'}`}>
                <div className="bg-white dark:bg-dark-bg w-full sm:w-3/4 md:w-1/2  xl:w-4/12 rounded-lg p-4 pb-8">
                    ...
                    <div className="card-body">
                        <form className=" py-3 px-8" >
                           <div>
                             <h2 className='text-base dark:text-white m-4'>{t('Are you sure you want to approve this updated ratings')} ?</h2>
                           </div>
                            <div className="w-full flex justify-between">
                                <button className='py-2 w-[40%] md:w-1/3 bg-[#31699C] rounded font-sans text-sm text-white' onClick={() => removeApproveModel()}>{t('cancel')}</button>
                                <button className='text-white py-2 w-[40%] md:w-1/3 bg-primary rounded'>{t('Approve')}</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            {/* =========================== Start::  rejectModel =============================== */}
     <div className={`min-h-full w-screen z-30 bg-black bg-opacity-30 backdrop-blur-sm absolute flex items-center justify-center px-4 ${rejectModel === true ? 'block' : 'hidden'}`}>
                <div className="bg-white dark:bg-dark-bg w-full sm:w-3/4 md:w-1/2  xl:w-4/12 rounded-lg p-4 pb-8">
                    <div className="card-title w-full flex  flex-wrap justify-center items-center  ">
                        <h3 className='font-bold text-sm dark:text-white text-center w-11/12'>
                        ...
                        <form className=" py-3 px-8" >
                           <div>
                            ...
                            <div className="w-full flex justify-between">
                                ...
                                <button className='text-white py-2 w-[40%] md:w-1/3 bg-primary rounded'>{t('Reject')}</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div className="px-3 md:px-8 mt-20">
                    <div className="bg-white dark:bg-dark-bg shadow-lg px-5 py-8 rounded-md w-[100%] mx-auto lg:w-[80%] lg:ml-52 mb-10">
                        <div className=" flex items-center justify-between pb-6">
                            <div>
                                <h2 className="text-gray-800 dark:text-white font-semibold text-xl">{t('Updated Ratings')}</h2>
                                ...
                                <div className="inline-block w-full lg:min-w-full shadow rounded-lg overflow-hidden">
                                    <table className="min-w-full leading-normal">
                                        <thead>
                                            <tr>
                                                <th
                                                    className="p-6 border-b-2 border-gray-200 bg-gray-100 dark:bg-dark-tertiary dark:text-white text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                                    {t('name')}
                                                </th>
                                                <th
                                                ...
                                                <th
                                                    className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 dark:bg-dark-tertiary dark:text-white text-left text-xs font-semibold text-gray-600 uppercase tracking-wider text-center">
                                        ...
                                        <tbody>
                                            {developers.map((developer: any, index: any) => {
                                              let rowTheme = index % 2 !== 0 ? 'bg-light-bg dark:bg-dark-tertiary' : 'bg-white dark:bg-dark-bg';
                                              return (
                                                ...
                                                <div className='flex flex-row'>
                                                   <div className="cursor-pointer" onClick={() =>{
                                                    ...
                                                    {rowId == index.toString() && showActions ? <div className='absolute bg-white z-20 dark:bg-dark-bg text-gray-500 dark:text-white ml-4 flex justify-center items-center border rounded dark:border-white'>
                                                        <div className=' p-3'>
                                                        <ul>
                                                          <li className='hover:text-primary' onClick={() => removeRejectModel()}>
                                                            {t('Reject')}
                                                          </li>
                                                          <li className='hover:text-primary' onClick={() => removeApproveModel()}>
                                                            {t('Approve')}
                                                          </li>
                                                        </ul>
                                                        </div>
