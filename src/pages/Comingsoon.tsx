...
export default function Comingsoon(props: { title: any }) {
  ...
  return (
    <div className="flex items-center justify-center h-fit bg-light-bg dark:bg-dark-frame-bg py-4 font-serif">
      <div className="p-5 mx-2 bg-indigo-100 rounded-lg shadow-lg dark:bg-dark-bg md:p-20">
