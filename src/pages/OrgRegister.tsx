...
export default function OrgRegister() {
  ...
  return (
    <div className="md:flex md:flex-col md:items-center md:justify-center w-full min-h-screen text-center dark:bg-dark-frame-bg bg-gray-100 sm:flex sm:flex-row sm:items-center sm:justify-center">
      <div className="bg-white sm:rounded-2xl md:shadow-2xl md:flex 2xl:w-2/3 md:w-[90%] mt-6 md:mt-20 md:mb-16 xl:mt-16 xl:mb-0 md:max-w-4xl sm:max-w-2xl sm:shadow-none dark:shadow-2xl ">
        <div className="2xl:w-3/5 md:w-screen 2xl:p-5 md:p-14 sm:w-full sm:p-2 dark:bg-dark-bg dark:rounded-tl-xl dark:rounded-bl-xl">
        ...
        <div className="md:w-2/5 bg-primary text-white lg:rounded-tr-2xl lg:rounded-br-2xl dark:rounded-br-2xl dark:rounded-tr-2xl md:py-14 md:px-2 sm:w-full dark:rounded-none sm:rounded-none sm:px-12 sm:py-4 md:block sm:hidden dark:text-dark-text-fill ">
          ...
          <button
            type="button"
            className="rounded bg-white text-primary  px-3 font-bold py-2 mt-3"
          >
